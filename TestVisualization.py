...
class Wolfpack(object):
    ...
    def update_state(self, hunter_collective_action, food_collective_action):
        ...
        update_results_food = self.calculate_new_position(food_collective_action, prev_food_position, prev_food_orientation)
...
class AdHocWolfpack(Wolfpack):
    def __init__(self, grid_height, grid_width, agent, args= None, sight_sideways=8,
                 sight_radius=8, num_players=5, max_food_num=2, food_freeze_rate=0,
                 max_time_steps=200, coop_radius=4, groupMultiplier=2, scheduler=None, with_vis=False):
        self.agent = agent
        agent_list = [agent]
...
parser.add_argument('--filename', type=str, default="params_54")
